<template>
    <section class="section">
        <div class="container">
            <h1 class="title">ລາຍການພິມໃຫ້ກັບ ຊ່ອງທາງ Online</h1>
            ...
            <b-table :data="convertedForms" :striped="true"
                ...
                <template slot-scope="props">
                    ...
                    <b-table-column field="createdate" label="ວັນທີພິມ">
	...
	export default {
		...
		methods: {
			loadPaymentForms() {
				...
				RestAPI.makerPrintOnlineReport(d1, d2)
