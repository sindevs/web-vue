                    ...
                    <div class="box">
                        ...
                        <b-field label="ປີທີ່ຈະຊຳລະ">
                            <table class="table is-fullwidth" v-if="vehicleInfo.payabletax.length > 0">
                                ...
                                <tbody>
                                <tr v-for="(row, index) in vehicleInfo.payabletax" :key="row.tax.tax_year"
                            ...
                            <div class="box" v-else>
                                ບໍ່ມີຄ່າທຳນຽມ ທີ່ຕ້ອງຊຳລະ
                            </div>
                        </b-field>
                        <b-field label="ປີທີ່ເລືອກ">
                            <b-input :value="_.map(selectedTaxItems,(o) => {return o.tax.tax_year}).join(',')" expanded
                                     disabled></b-input>
                        </b-field>

                        <b-field label="ລວມເງິນທີ່ຕ້ອງຈ່າຍ">
                            <b-input :value="_.map(selectedTaxItems,(o) => {return o.tax.amt + o.fine.fineamount}).reduce((sum, n) => sum + n, 0) | formatNumberLocal" expanded
                                     disabled></b-input>
                        </b-field>
	...
	export default {
		...
		methods: {
			...
			async onSaveClicked() {
				...
				RestAPI.makerMakePayment(req).then(res => {
